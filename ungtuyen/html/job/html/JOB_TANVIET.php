    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <video autoplay="autoplay" loop="loop" width="100%" height="240">
                <source src="/PROJECT_JOB/image/VIDEO_MP4/TANVIET.mp4" type="video/mp4" />
            </video>
        </div>
        <!-- Thông tin về công việc -->
        <div class="row myjob_favorites">
            <div class="col-sm-4">
                <img src="/PROJECT_JOB/image/LOGOVIECLAM/LOGOVLMN/LOGO-CHUNGKHOANG - Copy.jpg" alt="">
            </div>
            <div class="col-sm-8">
                <h2 style="font-weight: bold; text-align: center;">CÔNG TY CỔ PHẦN CHỨNG KHOÁN TÂN VIỆT</h2>
                <p>
                    <b>Địa điểm :</b> <br>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <hr>
                                    <form method="POST" action="JOB_TANVIET.php" enctype="multipart/form-data">
