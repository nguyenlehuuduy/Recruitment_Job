...
<head>
    <title>LIXIL GLOBAL MANUFACTURING</title>
    <meta charset="UTF-8">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <video autoplay="autoplay" loop="loop" width="100%" height="240">
                <source src="/image/VIDEO_MP4/LIXIL.mp4" type="video/mp4" />
            </video>
        </div>
        <!-- Thông tin về công việc -->
        <div class="row myjob_favorites">
            <div class="col-sm-4">
                <img src="/PROJECT_JOB/image/LOGOVIECLAM/LOGOVLMN/LOGO-LIXIL - Copy.jpg" alt="">
            </div>
            <div class="col-sm-8">
                <h2 style="font-weight: bold;text-align: center;">LIXIL GLOBAL MANUFACTURING</h2>
                <p>
                    <b>Địa điểm :</b> <br>
        ...
        <!-- img miêu tả sương sương công việc  -->
        <div class="row">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <hr>
                                    <form method="POST" action="JOB_LIXIL.php" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="row g-3">
                                    <div class="col-md-6">
                                        <label for="inputAddress" class="form-label">Tên </label>
                                        <input type="text" class="form-control" id="inputAddress" placeholder="Nhập tên của bạn">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputNảm" class="form-label">Họ</label>
                                        <input type="password" class="form-control" id="inputPassword4" placeholder="Nhập họ của bạn">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputEmail4" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="inputEmail4" placeholder="Nhập Email của bạn">
                                    </div>
                                    <div class="col-12">
                                        <label for="inputAddress2" class="form-label">Địa chỉ</label>
                                        <input type="text" class="form-control" id="inputAddress2" placeholder="Nhập TP bạn đang sinh sống">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputCity" class="form-label">Gửi CV của bạn</label>
                            ...
                            <div class="modal-footer">
                                <input id="button_green" type="submit" class="btn btn-success" style="width: 100%;" style="width: 100%;" value="Gửi">
                            </div>
                        </div>
                    </div>
                </div>
