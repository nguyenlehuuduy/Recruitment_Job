...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <video autoplay="autoplay" loop="loop" width="100%" height="240">
                <source src="/PROJECT_JOB/image/VIDEO_MP4/ANVIETPHAT.mp4" type="video/mp4" />
            </video>
        </div>
        <!-- Thông Tin Công Việc  -->
        <div class="row myjob_favorites">
            <div class="col-sm-4">
                <img src="/PROJECT_JOB/image/LOGOVIECLAM/LOGOVLMN/LOGO-CTTNHHAnVIet.jpg" alt="">
            </div>
            <div class="col-sm-8">
                <h2 style="font-weight: bold; text-align: center;">CÔNG TY TNHH MTV NĂNG LƯỢNG AN VIỆT PHÁT</h2>
                <p>
                    <b>Địa điểm :</b> <br>
        ...
        <div class="container" id="bug" style="border: 1px solid white;">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <hr>
                                    <form method="POST" action="JOB_ANVIETPHAT.php" enctype="multipart/form-data">
    ...
    <!-- Giới thiệu các việc làm đang tuyển  -->
    <div class="container">
    ...
    <!-- Video gửi thông điệp về làm việc  -->
    <div class="container-fluid">
        <div class="row">
